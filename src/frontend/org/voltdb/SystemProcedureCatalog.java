...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable allowedInShutdown transactional
        ...
        builder.put("@RestartDRConsumerNT",     new Config("org.voltdb.sysprocs.RestartDRConsumerNT",      true,  false, false, 0,    VoltType.INVALID,   true,  false, true,  true,      false,  false,            false, false ));
